...
module.exports = {
name: "playlist",
description: "Playlist commandok kezelése.",
options: [
{
name: "create",
...
{
name: "name",
description: "Playlist neve amit létre szeretnél hozni.",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "public",
description: "Publikus legyen?",
...
{
name: "delete",
description: "Playlist törlése.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
description: "Playlist neve amit törölni szeretnél",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "add-music",
description: "Zene hozzáadása playlisthez.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "playlist-name",
description: "Playlist neve",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "name",
description: "Zenecím/link.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "list",
description: "Zenék keresése playlistben",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
...
{
name: "lists",
description: "Minden playlist böngészése",
type: ApplicationCommandOptionType.Subcommand,
options: []
},
{
name: "top",
description: "Legfelkapottabb playlistek",
type: ApplicationCommandOptionType.Subcommand,
options: []
}
...
.setFooter({ text: `Muzsikabot by K,M,G` })
