...
if(config.shardManager.shardStatus == true){
            const getServer = async (guildID) => {
             ...
             if (!guild) return interaction.reply({ content: "Nem vagyok ezen a szerveren!", ephemeral: true }).catch(e => { });
    ...
    if (!guild) return interaction.reply({ content: "Nem vagyok a szerveren!", ephemeral: true }).catch(e => { });
