...
module.exports = {
  name: "channel",
  description: "Beállíthatod, melyik csatornán/csatornákon fogadjon a bot parancsokat.",
  permissions: "0x0000000000000020",
  options: [{
    name: "add",
    description: "Csatorna hozzáadása",
    type: ApplicationCommandOptionType.Subcommand,
    options: [
      {
        name: 'channel',
        description: 'említsd meg a csatornát',
  ...
  {
    name: "remove",
    description: "csatorna eltávolítása",
    type: ApplicationCommandOptionType.Subcommand,
    options: [
      {
        name: 'channel',
